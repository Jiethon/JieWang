...
class AccessibilityInputFilter extends InputFilter implements EventStreamTransformation {
    ...
    static final int FLAG_FEATURE_ONEHAND_CTRL = 0x00000040;
    ...
    public void onInputEvent(InputEvent event, int policyFlags) {
        ...
        // BEGIN leo_liao@asus.com, One-hand control
            ...
            if ((mEnabledFeatures & FLAG_FEATURE_ONEHAND_CTRL) != 0
                    && event.isFromSource(InputDevice.SOURCE_CLASS_POINTER)) {
                // Disable one-hand control once the non-touch event is received
                mAms.handleNonTouchEvent();
            }
        }
        // END leo_liao@asus.com
    }
    ...
    private void processKeyEvent(EventStreamState state, KeyEvent event, int policyFlags) {
        ...
        if ((mEnabledFeatures & FLAG_FEATURE_ONEHAND_CTRL) != 0
            ...
            if (keyCode == KeyEvent.KEYCODE_HOME
                ...
                mMagnificationGestureHandler.dismissCling();
            }
        }
        // END leo_liao@asus.com
    ...
    private void enableFeatures() {
        ...
        if ((mEnabledFeatures & FLAG_FEATURE_ONEHAND_CTRL) != 0) {
            if ((mEnabledFeatures & FLAG_FEATURE_TOUCH_EXPLORATION) != 0) {
                // Force to disable one-hand control while touch exploration is enabled
                ...
                mMagnificationGestureHandler.activateOneHandCtrl();
            }
        } else if ((mEnabledFeatures & FLAG_FEATURE_CONTROL_SCREEN_MAGNIFIER) != 0
            ...
            addFirstEventHandler(mMagnificationGestureHandler);
            mMagnificationGestureHandler.deactivateOneHandCtrl();
        }
        // END leo_liao@asus.com
