...
interface IWindowManager
{
    ...
    boolean getFullscreenMode(String packageName);
    /// @}
    /*
     * adrian_sung@asus.com, EPONE-1256 [IME] CN SKU Caps Lock Key Function Discussion
     * @hide
     */
    int getKeyEventMetaState();

    /**
     * leo_liao@asus.com, One-hand control
     * for query display magnification
     * return null if display is not magnified
     */
    Rect getDisplayMagnifiedRect(int displayId);

    /*
     * scott_su@asus.com, To get last WallpaperOffsetData. it's for blur wallpaper in lockscreen and recent app.
     * 
     */
    float[] asusGetWallpaperOffset();
}
