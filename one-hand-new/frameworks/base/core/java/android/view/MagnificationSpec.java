...
public class MagnificationSpec implements Parcelable {
    ...
    public float extraScaleX = 1.0f;
    public float extraScaleY = 1.0f;
...
//        }
    ...
    public boolean isNop() {
        return scale == 1.0f && offsetX == 0 && offsetY == 0
            // BEGIN: archie_huang@asus.com
            // For feature: Video Player scaling
            && extraScaleX == 1.0f && extraScaleY == 1.0f;
            // END: archie_huang@asus.com
    }
    ...
    public static MagnificationSpec obtain(MagnificationSpec other) {
        ...
        // BEGIN: archie_huang@asus.com
        // For feature: Video Player scaling
        info.extraScaleX = other.extraScaleX;
        info.extraScaleY = other.extraScaleY;
        // END: archie_huang@asus.com
    ...
    public void setTo(MagnificationSpec other) {
        ...
        // BEGIN: archie_huang@asus.com
        // For feature: Video Player scaling
        extraScaleX = other.extraScaleX;
        extraScaleY = other.extraScaleY;
        // END: archie_huang@asus.com
    }
    ...
    public void writeToParcel(Parcel parcel, int flags) {
        ...
        // BEGIN: archie_huang@asus.com
        // For feature: Video Player scaling
        parcel.writeFloat(extraScaleX);
        parcel.writeFloat(extraScaleY);
        // END: archie_huang@asus.com
        recycle();
    }
    ...
    public boolean equals(Object other) {
        ...
        return scale == s.scale && offsetX == s.offsetX && offsetY == s.offsetY
            // BEGIN: archie_huang@asus.com
            // For feature: Video Player scaling
            && extraScaleX == s.extraScaleX && extraScaleY == s.extraScaleY;
            // END: archie_huang@asus.com
    }
    ...
    public String toString() {
        ...
        // BEGIN: archie_huang@asus.com
        // For feature: Video Player scaling
        builder.append(",extraScaleX:");
        builder.append(Float.toString(extraScaleX));
        builder.append(",extraScaleY:");
        builder.append(Float.toString(extraScaleY));
        // END: archie_huang@asus.com
    ...
    private void initFromParcel(Parcel parcel) {
        ...
        // BEGIN: archie_huang@asus.com
        // For feature: Video Player scaling
        extraScaleX = parcel.readFloat();
        extraScaleY = parcel.readFloat();
        // END: archie_huang@asus.com
    }
