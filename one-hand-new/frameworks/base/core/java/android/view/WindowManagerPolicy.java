...
public interface WindowManagerPolicy {
    ...
    public final static int FLAG_UNLOCK = 0x00000080;
    ...
    public interface WindowManagerFuncs {
        ...
        //+++ RobertJW, add boolean val to enable/disable confirm dialog
        ...
        public InputConsumer addGestureInputConsumer(Looper looper,
                InputEventReceiver.Factory inputEventReceiverFactory);
        // END: archie_huang@asus.com
    }
    ...
    // BEGIN: aras_yin add for smart charging
    /** Screen turned on because of unknown reason
     * @hide
     */
    public final int OFF_BECAUSE_OF_UNKNOWN = 0;

    /** Screen turned off because of timeout
     * @hide
     * */
    public final int OFF_BECAUSE_OF_TIMEOUT_POSTPONED = 5;

    /** Screen turned on because of window manager
     * @hide
     */
    public final int OFF_BECAUSE_OF_WM_TURN_ON = 6;
    // END: aras_yin
    ...
    public int interceptMotionWhenProximityEnabled(long whenNanos, int policyFlags);
