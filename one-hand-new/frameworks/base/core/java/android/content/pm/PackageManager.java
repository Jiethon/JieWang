...
public abstract class PackageManager {
    ...
    //[TwinApps] {
    /**
     * Querying flag: if set, only query intent by specific user.
     * For Owner and TwinApps, default will query both two's intents.
     * @hide
     */
    public static final int MATCH_USER = 0x01000000;
    /**
     * Querying flag: if set, only query intent from resolverActivity.
     * For Owner and TwinApps, default will query both two's intents.
     * @hide
     */
    public static final int MATCH_RESOLVER = 0x02000000;
    //[TwinApps] }
    ...
    /**
     * Flag parameter for {@link #installPackage} to indicate that it is install
     * from PackaManager that means that the app is an untrusted app
     *
     * @hide
     */
    public static final int INSTALL_UNTRUSTED_APP = 0x40000000;

    /**
     * Flag parameter for {@link #installPackage} to indicate that it is install
     * from ASUS virtual preload mechanism and will skip the package verification
     * during the install process
     *
     * @hide
     */
    public static final int INSTALL_VIRTUAL_PRELOAD = 0x80000000;
    ...
    public static final long MAXIMUM_VERIFICATION_TIMEOUT = 60*60*1000;
     ...
     //Sharon+++Feature for ASUS Zenfone3 vibration intensity settings
	/** Feature for ASUS Zenfone3 vibration intensity settings
		* @hide
		*/
	   @SdkConstant(SdkConstantType.FEATURE)
	   public static final String FEATURE_ASUS_VIBRATION_INTENSITY = "asus.software.vibration.intensity";
    //Sharon---Feature for ASUS Zenfone3 vibration intensity settings
    ...
    //+++ ASUS defined hardware feature
    /**
     * Feature for ASUS EeePad Dock support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_DOCK = "asus.hardware.dock";

    /**
     * Feature for ASUS EeePad Dock EC firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_DOCK_EC = "asus.hardware.fw.dock_ec";

    /**
     * Feature for ASUS EeePad Dock gaugel IC firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_DOCK_GIC = "asus.hardware.fw.dock_gaugel_ic";

    /**
     * Feature for ASUS EeePad Pad EC firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_PAD_EC = "asus.hardware.fw.pad_ec";

    /**
     * Feature for ASUS EeePad Pad gaugel IC firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_PAD_GIC = "asus.hardware.fw.pad_gaugel_ic";

    /**
     * Feature for ASUS EeePad Camera ISP firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_CAMERA_ISP = "asus.hardware.fw.camera_isp";

    /**
     * Feature for ASUS EeePad Touch firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_TOUCH = "asus.hardware.fw.touch";

    /**
     * Feature for ASUS PadFone Station Pad EC firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_PADFONE_STATION_PAD_EC = "asus.hardware.fw.pfs_pad_ec";

    /**
     * Feature for ASUS PadFone Station Touch firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_PADFONE_STATION_TOUCH = "asus.hardware.fw.pfs_touch";

    /**
     * Feature for ASUS PadFone Station Camera ISP firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_PADFONE_STATION_CAMERA_ISP = "asus.hardware.fw.pfs_camera_isp";

    /**
     * Feature for ASUS EeePad Dock Battery Info support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_BATTERY_DOCK = "asus.hardware.battery.dock";

    /**
     * Feature for ASUS EeePad Scalar firmware support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_FIRMWARE_SCALAR = "asus.hardware.fw.scalar";
    //---

    /** wilson_chen@asus.com
     * Feature for ASUS PowerPack/SoundSleeve Battery Info support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_BATTERY_PACK = "asus.hardware.battery.pack";

    /** wilson_chen@asus.com
     * Feature for ASUS ActivePen Battery Info support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_BATTERY_ACTIVEPEN = "asus.hardware.battery.activepen";
   ...
   //+++ ASUS defined hardware feature
    /**
     * Feature for ASUS EeePad Keyboard support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    /**
     * Feature for ASUS EeePad Hall Sensor support
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    /**
     * Feature for ASUS TwinApps
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_TWINAPPS = "asus.software.twinapps";

    //++ Quinton_Cheng@asus.com
    /**
     * Feature for ASUS ZenUI 4.5 checking
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_ZENUI_FOUR_FIVE = "asus.software.zenui.fourfive";
    //-- Quinton_Cheng@asus.com

    //++Yuchen_Chang@asus.com
    /**
     * Feature for ASUS touchgesture double tap setting
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    //++Yuchen_Chang@asus.com
    /**
     * Feature for ASUS touchgesture swipe up setting
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    //++Yuchen_Chang@asus.com
    /**
     * Feature for ASUS touchgesture launch app setting
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
   ...
   //--Yuchen_Chang@asus.com
    ...
    /**
     * Feature for ASUS Whole System One hand control
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
...
//BEGIN: Jeffrey_Chiang@asus.com
    /**
     * Glove mode porting
     * Add the hardware feature "glove mode"
     * Feature for ASUS glove mode setting
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
...
//END: Jeffrey_Chiang@asus.com
    ...
    //BEGIN: Chilin_Wang@asus.com,N-porting
    /**
     * Feature for ASUS long press trigger camera setting
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    ...
    //BEGIN: Wilson_Chen@asus.com
    /**
     * Feature for ASUS battery smart charging.
     * @hide
     */
    @SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_BATTERY_SMART_CHARGING = "asus.software.battery.smart_charging";
	//END
    ...
    */
     ...
     * @hide
     */
    public abstract void deleteBundledSystemPackages(String[] packageNames);
     ...
     * @hide
     */
    public abstract void restoreCustHiddenPackage(String packageName);

    /**
     * @hide
     */
    public abstract void customizedByLangcode(String lang);
    //---ASUS: new APIs

    //+++Asus RobertJW get untrusted app lsit
    /**
     * @hide
     */
    public abstract List<String> getUntrustedAppList();
    //---
     ...
     * @hide
     */
    public abstract boolean isInApp2sdBlacklist(String packageName);
     ...
     * @hide
     */
    public abstract void setOverrideMaxAspect(String packageName, float maxAspect, int userId);
    // END: archie_huang@asus.com

	
	//add by mohongwu@wind-mobi.com 2016/11/16 start
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_INSTANT_CAMERA = "asus.hardware.instant_camera";
	
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_DISPLAY_HIGH_BRIGHTNESS = "asus.hardware.display.high_brightness";
	
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_MARKETAPP = "asus.software.marketapp";
	
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_ONEHAND = "asus.software.onehand";
	
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_ZENUI = "asus.software.zenui";
	
	/**
     * @hide
     */
	@SdkConstant(SdkConstantType.FEATURE)
    public static final String FEATURE_ASUS_SNAPVIEW = "asus.software.snapview";
	//add by mohongwu@wind-mobi.com 2016/11/16 end
}
